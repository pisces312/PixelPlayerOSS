...
> 最近一次实测：2026-09-18（同日两次：驻留上限与缓冲态见 `car-lyrics-title-plan.md` §9.6；空行标记阈值见 `car-lyrics-blank-markers.md` §6.2，用设备上的真实 mp3 播完整曲）；此前 2026-09-17，pixel6 AVD（API 34）+ 本仓库 debug `0.4.2-pisces.1`。
