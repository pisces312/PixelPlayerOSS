            ...
            actions = {
                Row(
                    ...
                    SortToggleButton(
                        ...
                        selected = songSortMetric == SongSortMetric.PLAYS,
                        onClick = { songSortMetric = SongSortMetric.PLAYS }
                    )
                    SortToggleButton(
                        label = stringResource(R.string.presentation_batch_g_stats_sort_duration),
                        selected = songSortMetric == SongSortMetric.DURATION,
                        onClick = { songSortMetric = SongSortMetric.DURATION }
                    )
                }
            }
        )
